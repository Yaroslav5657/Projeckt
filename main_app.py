...
from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QComboBox, QPushButton, QDialog, QGraphicsOpacityEffect
...
class DesktopApp(QMainWindow):
    def __init__(self):
        ...
        # Инициализируем объект для выключения компьютера
    ...
    def open_shutdown(self):
        # Отображаем окно выключения компьютера
